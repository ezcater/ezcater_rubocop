...
## 5.3.0
- Add `FeatureFlagNameValid` cop to validate correct feature flag name format, adopted from the cop in `ez-rails`: https://github.com/ezcater/ez-rails/blob/main/cops/rubocop/cops/feature_flags_flag_name.rb.
